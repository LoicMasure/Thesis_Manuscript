...
\begin{titlepage}
  	\centering
    \includegraphics[width=0.4\textwidth]{su.pdf}
    \hfill
    \includegraphics[width=0.2\textwidth]{leti}\\
    \vspace{1cm}
      	{\huge \textsc{Sorbonne Université}}\\
    \vspace{1cm}
      	{\Large \textsc{École Doctorale n° \(130\)}}\\
    \vspace{0.3cm}
      	{\large \textsc{Informatique, Télécommunications, Électronique de Paris}}\\
    \vspace{1cm}
		{\large \textsc{CEA Grenoble - \textsc{Leti} \hfill Laboratoire d'Informatique de Paris 6}}\\
	...
	\vspace{1cm}
		par \@author{}\\
	\vspace{0.5cm}
		Thèse de doctorat d' \@specialite{}\\
	\vspace{0.5cm}
		Dirigée par \@directeur{} et \@encadrant{}\\
	\vspace{0.5cm}
